...
int main( int argc, char ** argv ) 
{
    ...
    set_bg_color(nh, 100, 0, 250);
    show_all_bg_color(nh);

    // 輸出與載入設定好的參數
    system("rosparam dump /home/brian/hello_ws/src/pain/config/data.yaml");
    system("rosparam load /home/brian/hello_ws/src/pain/config/data.yaml");
